...
from synonymous_sentences import Solution
...
@time_tests
class TestSynonymousSentences(TestCase):
    def setUp(self):
        # This method is called before each test
        self.solution = Solution()

    def test1_two_synonyms(self):
        ...
        result = self.solution.generate_sentences(synonyms, text)

        self.assertListEqual(result, expected)

    def test2_one_synonym(self):
...
if __name__ == '__main__':
    suite = TestLoader().loadTestsFromTestCase(TestSynonymousSentences)
