...
from valid_brackets import Solution
...
@time_tests
class TestValidBrackets(TestCase):
    def setUp(self):
        # This method is called before each test
        self.solution = Solution()

    def test1_parentheses(self):
        s = "()"
        expected = True
...
if __name__ == '__main__':
    suite = TestLoader().loadTestsFromTestCase(TestValidBrackets)
