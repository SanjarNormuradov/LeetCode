...
class TestValidBrackets : public ::testing::Test {
protected:
...
TEST_F(TestValidBrackets, test1_parentheses) {
    string s = "()";
    bool expected = true;
...
TEST_F(TestValidBrackets, test2_trio) { 
    string s = "()[]{}";
    bool expected = true;
    bool result = solution->isValid(s);
...
TEST_F(TestValidBrackets, test3_roundCurly) { 
    string s = "(]";
    bool expected = false;
    bool result = solution->isValid(s);
...
TEST_F(TestValidBrackets, test4_doubleRound) { 
    string s = "((";
    bool expected = false;
    bool result = solution->isValid(s);
