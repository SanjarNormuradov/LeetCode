#include "palindrome_permutationII.cpp"
...
class TestPalindromePermutationII : public ::testing::Test {
protected:
...
TEST_F(TestPalindromePermutationII, test1_aabb) {
    string s = "aabb";
    vector<string> expected = {"abba", "baab"};
...
TEST_F(TestPalindromePermutationII, test2_aabbc) { 
    string s = "aabbc";
    vector<string> expected = {"abcba", "bacab"};
    vector<string> result = solution->generatePalindromes(s);
    sort(expected.begin(), expected.end());
    sort(result.begin(), result.end());
    ASSERT_EQ(expected, result);
...
TEST_F(TestPalindromePermutationII, test3_abc) { 
    string s = "abc";
