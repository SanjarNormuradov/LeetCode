...
from bfs_shortest_path_binary_matrix import Solution
...
class TestBFSShortestPathBinaryMatrix(TestCase):
    def setUp(self):
...
if __name__ == '__main__':
    suite = TestLoader().loadTestsFromTestCase(TestBFSShortestPathBinaryMatrix)
