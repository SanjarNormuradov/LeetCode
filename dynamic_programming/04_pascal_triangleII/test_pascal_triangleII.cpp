...
class TestPascalTriangleII : public ::testing::Test {
protected:
...
TEST_F(TestPascalTriangleII, test1_n4) { 
    int rowIndex = 4;
...
TEST_F(TestPascalTriangleII, test2_n0) { 
    int rowIndex = 0;
...
TEST_F(TestPascalTriangleII, test3_n6) { 
    int rowIndex = 6;
    vector<int> expected = {1, 6, 15, 20, 15, 6, 1};
    vector<int> result = solution->getRow(rowIndex);
