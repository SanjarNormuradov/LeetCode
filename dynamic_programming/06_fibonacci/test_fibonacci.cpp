...
TEST_F(TestFibonacci, test1_fib0) { 
    int n = 0;
    int expected = 0;
...
TEST_F(TestFibonacci, test2_fib1) { 
    int n = 1;
    int expected = 1;
    int result = solution->fib(n);
...
TEST_F(TestFibonacci, test3_fib2) { 
    int n = 2;
    int expected = 1;
    int result = solution->fib(n);
...
TEST_F(TestFibonacci, test4_fib3) { 
    int n = 3;
    int expected = 2;
    int result = solution->fib(n);
...
TEST_F(TestFibonacci, test5_fib4) { 
    int n = 4;
    int expected = 3;
    int result = solution->fib(n);
...
TEST_F(TestFibonacci, test6_fib7) { 
    int n = 7;
    int expected = 13;
    int result = solution->fib(n);
