...
class TestLongestIncreasingPath : public ::testing::Test {
protected:
...
TEST_F(TestLongestIncreasingPath, test1_Path1) { 
...
TEST_F(TestLongestIncreasingPath, test2_Path2) { 
...
TEST_F(TestLongestIncreasingPath, test3_Path3) { 
...
TEST_F(TestLongestIncreasingPath, test4_Path4) { 
