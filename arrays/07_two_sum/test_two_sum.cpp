...
TEST_F(TestTwoSum, test1_2_7_11_15) { 
    vector<int> nums = {2, 7, 11, 15};
    int target = 9;
    vector<uint16_t> expected = {0, 1};
    vector<uint16_t> result = solution->twoSum(nums, target);

    ASSERT_EQ(expected, result);
}

TEST_F(TestTwoSum, test2_3_2_4) { 
    vector<int> nums = {3, 2, 4};
    int target = 6;
    vector<uint16_t> expected = {1, 2};
    vector<uint16_t> result = solution->twoSum(nums, target);

    ASSERT_EQ(expected, result);
}

TEST_F(TestTwoSum, test3_3_3) { 
    vector<int> nums = {3, 3};
    int target = 6;
    vector<uint16_t> expected = {0, 1};
    vector<uint16_t> result = solution->twoSum(nums, target);
